...
public class Controller {
    ...
    private void saveInformationAboutGame(){
        String filePath = "resultGames.txt";
        SimpleDateFormat formatForDateNow = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
        String text = "Победил:"+model.getMyName()+" Комната: "+view.getPort()+" Дата и время: "+ formatForDateNow.format(new Date())+"\n";
